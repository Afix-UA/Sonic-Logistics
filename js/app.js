(() => {
    var __webpack_modules__ = [ (module, __unused_webpack_exports, __webpack_require__) => {
        (function(f) {
                    ...
                    (function(global) {
                        (function() {
                            ...
                            $jscomp.polyfillIsolated = function(a, b, c, d) {
                                ...
                                e = $jscomp.propertyToPolyfillSymbol[e], $jscomp.defineProperty(d, e, {
                                    configurable: !0,
                                    writable: !0,
                                    value: b
                                })));
                            ...
                            goog.loadModule = function(a) {
                                ...
                                try {
                                    ...
                                    var c = {}, d = c;
                                    if ("function" === typeof a) d = a.call(void 0, d); else if ("string" === typeof a) goog.useSafari10Workaround() && (a = goog.workaroundSafari10EvalBug(a)), 
                                    d = goog.loadModuleFromSource_.call(void 0, d, a); else throw Error("Invalid module definition");
                                    var e = goog.moduleLoaderState_.moduleName;
                                    if ("string" === typeof e && e) goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(e, d, c !== d) : goog.SEAL_MODULE_EXPORTS && Object.seal && "object" == typeof d && null != d && Object.seal(d), 
                            ...
                            !COMPILED && goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function() {
                                ...
                                (a = this.getPathFromDeps_(a)) && (b || this.areDepsLoaded_(this.dependencies_[a].requires)) && (b = this.deferredCallbacks_[a]) && (delete this.deferredCallbacks_[a], 
                                b());
                            ...
                            goog.LoadController.prototype.pending = function() {}, goog.LoadController.prototype.registerEs6ModuleExports = function(a, b, c) {}, 
                            goog.LoadController.prototype.setModuleState = function(a) {}, goog.LoadController.prototype.clearModuleState = function() {}, 
                            goog.LoadController.prototype.defer = function(a) {}, goog.LoadController.prototype.areDepsLoaded = function() {}, 
                            goog.Dependency = function(a, b, c, d, e) {
                                ...
                                if (goog.global.CLOSURE_IMPORT_SCRIPT) goog.global.CLOSURE_IMPORT_SCRIPT(this.path) ? a.loaded() : a.pause(); else if (goog.inHtmlDocument_()) {
                                    ...
                                    if (!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING && goog.isDocumentLoading_()) {
                                        var d = function(h) {
                                            h.readyState && "complete" != h.readyState ? h.onload = d : (goog.Dependency.unregisterCallback_(e), 
                                            a.loaded());
                                        };
                                ...
                                var e = this;
                                if (goog.global.CLOSURE_IMPORT_SCRIPT) b(), this.contents_ && goog.global.CLOSURE_IMPORT_SCRIPT("", this.contents_) ? (this.contents_ = null, 
                                a.loaded()) : a.pause(); else {
                            ...
                            goog.object.unsafeClone = function(a) {
                                ...
                                if ("function" === typeof a.clone) return a.clone();
                                var c, b = Array.isArray(a) ? [] : "function" !== typeof ArrayBuffer || "function" !== typeof ArrayBuffer.isView || !ArrayBuffer.isView(a) || a instanceof DataView ? {} : new a.constructor(a.length);
                            ...
                            goog.fs.blob.getBlobWithProperties = function(a, b, c) {
                                ...
                                if (void 0 !== goog.global.Blob) return d = {}, b && (d.type = b), c && (d.endings = c), 
                                new Blob(a, d);
                            ...
                            goog.html.SafeStyle.create = function(a) {
                                ...
                                for (c in a) if (Object.prototype.hasOwnProperty.call(a, c)) {
                                    ...
                                    var d = a[c];
                                    null != d && (d = Array.isArray(d) ? module$contents$goog$array_map(d, goog.html.SafeStyle.sanitizePropertyValue_).join(" ") : goog.html.SafeStyle.sanitizePropertyValue_(d), 
                                    b += c + ":" + d + ";");
                                }
                            ...
                            goog.html.SafeStyle.sanitizePropertyValueString_ = function(a) {
                                ...
                                if (goog.html.SafeStyle.VALUE_RE_.test(b)) {
                                    if (goog.html.SafeStyle.COMMENT_RE_.test(a)) return goog.asserts.fail("String value disallows comments, got: " + a), 
                                    goog.html.SafeStyle.INNOCUOUS_STRING;
                                    if (!goog.html.SafeStyle.hasBalancedQuotes_(a)) return goog.asserts.fail("String value requires balanced quotes, got: " + a), 
                                    goog.html.SafeStyle.INNOCUOUS_STRING;
                                    if (!goog.html.SafeStyle.hasBalancedSquareBrackets_(a)) return goog.asserts.fail("String value requires balanced square brackets and one identifier per pair of brackets, got: " + a), 
                                    goog.html.SafeStyle.INNOCUOUS_STRING;
                                } else return goog.asserts.fail("String value allows only " + goog.html.SafeStyle.VALUE_ALLOWED_CHARS_ + " and simple functions, got: " + a), 
                                goog.html.SafeStyle.INNOCUOUS_STRING;
                            ...
                            goog.labs.userAgent.util.extractVersionTuples = function(a) {
                                for (var d, b = /(\w[\w ]+)\/([^\s]+)\s*(?:\((.*?)\))?/g, c = []; d = b.exec(a); ) c.push([ d[1], d[2], d[3] || void 0 ]);
                                return c;
                            };
                            ...
                            goog.html.SafeHtml.join = function(a, b) {
                                ...
                                var c = a.getDirection(), d = [], e = function(f) {
                                    Array.isArray(f) ? module$contents$goog$array_forEach(f, e) : (f = goog.html.SafeHtml.htmlEscape(f), 
                                    d.push(goog.html.SafeHtml.unwrap(f)), f = f.getDirection(), c == goog.i18n.bidi.Dir.NEUTRAL ? c = f : f != goog.i18n.bidi.Dir.NEUTRAL && c != f && (c = null));
                                };
                            ...
                            goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function(a, b, c) {
                                ...
                                e += ">") : (d = goog.html.SafeHtml.concat(c), e += ">" + goog.html.SafeHtml.unwrap(d) + "</" + a + ">", 
                                d = d.getDirection());
                            ...
                            goog.html.SafeHtml.combineAttributes = function(a, b, c) {
                                var e, d = {};
                                for (e in a) Object.prototype.hasOwnProperty.call(a, e) && (goog.asserts.assert(e.toLowerCase() == e, "Must be lower case"), 
                                d[e] = a[e]);
                                for (e in b) Object.prototype.hasOwnProperty.call(b, e) && (goog.asserts.assert(e.toLowerCase() == e, "Must be lower case"), 
                                d[e] = b[e]);
                            ...
                            goog.string.unescapeEntitiesUsingDom_ = function(a, b) {
                                ...
                                return a.replace(goog.string.HTML_ENTITY_PATTERN_, (function(e, f) {
                                    ...
                                    g || (goog.dom.safe.setInnerHtml(d, goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(goog.string.Const.from("Single HTML entity."), e + " ")), 
                            ...
                            goog.proto2.Message.prototype.copyFrom = function(a) {
                                ...
                                this != a && (this.values_ = {}, this.deserializedFields_ && (this.deserializedFields_ = {}), 
                                this.mergeFrom(a));
                            };
                            ...
                            goog.proto2.Message.prototype.getValueForTag_ = function(a) {
                                ...
                                return null == b ? null : this.lazyDeserializer_ ? a in this.deserializedFields_ ? this.deserializedFields_[a] : (b = this.lazyDeserializer_.deserializeField(this, this.fields_[a], b), 
                                this.deserializedFields_[a] = b) : b;
                            };
                            goog.proto2.Message.prototype.get$Value = function(a, b) {
                                var c = this.getValueForTag_(a);
                                return this.fields_[a].isRepeated() ? (a = b || 0, goog.asserts.assert(0 <= a && a < c.length, "Given index %s is out of bounds.  Repeated field length: %s", a, c.length), 
                                c[a]) : c;
                            };
                            ...
                            goog.proto2.Serializer.prototype.getDeserializedValue = function(a, b) {
                                ...
                                if (a.getFieldType() == goog.proto2.FieldDescriptor.FieldType.ENUM) return goog.proto2.Serializer.DECODE_SYMBOLIC_ENUMS && "string" === typeof b && (a = a.getNativeType(), 
                                a.hasOwnProperty(b)) ? a[b] : "string" === typeof b && goog.proto2.Serializer.INTEGER_REGEX.test(b) && (a = Number(b), 
                                0 < a) ? a : b;
                            ...
                            goog.proto2.PbLiteSerializer.prototype.getDeserializedValue = function(a, b) {
                                return a.getFieldType() == goog.proto2.FieldDescriptor.FieldType.BOOL ? (goog.asserts.assert("number" === typeof b || "boolean" === typeof b, "Value is expected to be a number or boolean"), 
                                !!b) : goog.proto2.Serializer.prototype.getDeserializedValue.apply(this, arguments);
                            };
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.createExtnPattern_ = function() {
                                var a = i18n.phonenumbers.PhoneNumberUtil.RFC3966_EXTN_PREFIX_ + i18n.phonenumbers.PhoneNumberUtil.extnDigits_("20"), b = "[  \\t,]*(?:e?xt(?:ensi(?:ó?|ó))?n?|ｅ?ｘｔｎ?|доб|anexo)[:\\.．]?[  \\t,-]*" + i18n.phonenumbers.PhoneNumberUtil.extnDigits_("20") + "#?", c = "[  \\t,]*(?:[xｘ#＃~～]|int|ｉｎｔ)[:\\.．]?[  \\t,-]*" + i18n.phonenumbers.PhoneNumberUtil.extnDigits_("9") + "#?", d = "[- ]+" + i18n.phonenumbers.PhoneNumberUtil.extnDigits_("6") + "#", e = "[  \\t]*(?:,{2}|;)[:\\.．]?[  \\t,-]*" + i18n.phonenumbers.PhoneNumberUtil.extnDigits_("15") + "#?", f = "[  \\t]*(?:,)+[:\\.．]?[  \\t,-]*" + i18n.phonenumbers.PhoneNumberUtil.extnDigits_("9") + "#?";
                                return a + "|" + b + "|" + c + "|" + d + "|" + e + "|" + f;
                            };
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.extractPossibleNumber = function(a) {
                                ...
                                0 <= b ? (a = a.substring(b), a = a.replace(i18n.phonenumbers.PhoneNumberUtil.UNWANTED_END_CHAR_PATTERN_, ""), 
                                b = a.search(i18n.phonenumbers.PhoneNumberUtil.SECOND_NUMBER_START_PATTERN_), 0 <= b && (a = a.substring(0, b))) : a = "";
                                return a;
                            };
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.getLengthOfNationalDestinationCode = function(a) {
                                ...
                                return 2 >= b.length ? 0 : this.getNumberType(a) == i18n.phonenumbers.PhoneNumberType.MOBILE && (a = i18n.phonenumbers.PhoneNumberUtil.getCountryMobileToken(a.getCountryCodeOrDefault()), 
                                "" != a) ? b[2].length + a.length : b[1].length;
                            };
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_ = function(a, b, c) {
                                for (var e, f, d = new goog.string.StringBuffer, g = a.length, h = 0; h < g; ++h) e = a.charAt(h), 
                                f = b[e.toUpperCase()], null != f ? d.append(f) : c || d.append(e);
                                return d.toString();
                            };
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.formatByPattern = function(a, b, c) {
                                ...
                                if (null != g) {
                                    ...
                                    if (0 < g.length) {
                                        ...
                                        0 < h.length ? (g = g.replace(i18n.phonenumbers.PhoneNumberUtil.NP_PATTERN_, h).replace(i18n.phonenumbers.PhoneNumberUtil.FG_PATTERN_, "$1"), 
                                        c.setNationalPrefixFormattingRule(g)) : c.clearNationalPrefixFormattingRule();
                                    }
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.formatNumberForMobileDialing = function(a, b, c) {
                                ...
                                "BR" == f && e ? e = 0 < a.getPreferredDomesticCarrierCodeOrDefault().length ? this.formatNationalNumberWithPreferredCarrierCode(a, "") : "" : d == i18n.phonenumbers.PhoneNumberUtil.NANPA_COUNTRY_CODE_ ? (b = this.getMetadataForRegion(b), 
                                e = this.canBeInternationallyDialled(a) && this.testNumberLength_(this.getNationalSignificantNumber(a), b) != i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_SHORT ? this.format(a, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL) : this.format(a, i18n.phonenumbers.PhoneNumberFormat.NATIONAL)) : e = (f == i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY || ("MX" == f || "CL" == f || "UZ" == f) && e) && this.canBeInternationallyDialled(a) ? this.format(a, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL) : this.format(a, i18n.phonenumbers.PhoneNumberFormat.NATIONAL); else if (h && this.canBeInternationallyDialled(a)) return c ? this.format(a, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL) : this.format(a, i18n.phonenumbers.PhoneNumberFormat.E164);
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.formatInOriginalFormat = function(a, b) {
                                ...
                                switch (a.getCountryCodeSource()) {
                                  ...
                                  default:
                                    ...
                                    d = this.getNationalSignificantNumber(a), c = this.chooseFormattingPatternForNumber_(c.numberFormatArray(), d), 
                                    null != c)) {
                                        d = c.getNationalPrefixFormattingRuleOrDefault();
                                        var e = d.indexOf("$1");
                                        0 >= e || (d = d.substring(0, e), d = i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(d), 
                                        0 != d.length && (b = c.clone(), b.clearNationalPrefixFormattingRule(), b = this.formatByPattern(a, i18n.phonenumbers.PhoneNumberFormat.NATIONAL, [ b ])));
                                    }
                                }
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.chooseFormattingPatternForNumber_ = function(a, b) {
                                for (var c, d = a.length, e = 0; e < d; ++e) {
                                    ...
                                    if (0 == f || 0 == b.search(c.getLeadingDigitsPattern(f - 1))) if (f = new RegExp(c.getPattern()), 
                                    i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(f, b)) return c;
                                }
                                return null;
                            };
                            i18n.phonenumbers.PhoneNumberUtil.prototype.formatNsnUsingPattern_ = function(a, b, c, d) {
                                var e = b.getFormatOrDefault(), f = new RegExp(b.getPattern()), g = b.getDomesticCarrierCodeFormattingRuleOrDefault();
                                c == i18n.phonenumbers.PhoneNumberFormat.NATIONAL && null != d && 0 < d.length && 0 < g.length ? (b = g.replace(i18n.phonenumbers.PhoneNumberUtil.CC_PATTERN_, d), 
                                e = e.replace(i18n.phonenumbers.PhoneNumberUtil.FIRST_GROUP_PATTERN_, b), a = a.replace(f, e)) : (b = b.getNationalPrefixFormattingRuleOrDefault(), 
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.testNumberLengthForType_ = function(a, b, c) {
                                ...
                                if (c == i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE) if (i18n.phonenumbers.PhoneNumberUtil.descHasPossibleNumberData_(i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(b, i18n.phonenumbers.PhoneNumberType.FIXED_LINE))) c = i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(b, i18n.phonenumbers.PhoneNumberType.MOBILE), 
                                i18n.phonenumbers.PhoneNumberUtil.descHasPossibleNumberData_(c) && (e = e.concat(0 == c.possibleLengthCount() ? b.getGeneralDesc().possibleLengthArray() : c.possibleLengthArray()), 
                                e.sort(), 0 == d.length ? d = c.possibleLengthLocalOnlyArray() : (d = d.concat(c.possibleLengthLocalOnlyArray()), 
                                d.sort())); else return this.testNumberLengthForType_(a, b, i18n.phonenumbers.PhoneNumberType.MOBILE);
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.extractCountryCode = function(a, b) {
                                ...
                                for (var c, d = a.length, e = 1; e <= i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_COUNTRY_CODE_ && e <= d; ++e) if (c = parseInt(a.substring(0, e), 10), 
                                c in i18n.phonenumbers.metadata.countryCodeToRegionCodeMap) return b.append(a.substring(e)), 
                                c;
                                return 0;
                            };
                            i18n.phonenumbers.PhoneNumberUtil.prototype.maybeExtractCountryCode = function(a, b, c, d, e) {
                                ...
                                if (null != b) {
                                    ...
                                    if (goog.string.startsWith(h, g) && (g = new goog.string.StringBuffer(h.substring(g.length)), 
                                    h = b.getGeneralDesc(), h = new RegExp(h.getNationalNumberPatternOrDefault()), this.maybeStripNationalPrefixAndCarrierCode(g, b, null), 
                                    g = g.toString(), !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(h, a.toString()) && i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(h, g) || this.testNumberLength_(a.toString(), b) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_LONG)) return c.append(g), 
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripInternationalPrefixAndNormalize = function(a, b) {
                                ...
                                if (i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(c)) return c = c.replace(i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN, ""), 
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripExtension = function(a) {
                                ...
                                if (0 <= c && i18n.phonenumbers.PhoneNumberUtil.isViablePhoneNumber(b.substring(0, c))) for (var d = b.match(i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERN_), e = d.length, f = 1; f < e; ++f) if (null != d[f] && 0 < d[f].length) return a.clear(), 
                                a.append(b.substring(0, c)), d[f];
                                return "";
                            };
                            ...
                            i18n.phonenumbers.PhoneNumberUtil.prototype.parseHelper_ = function(a, b, c, d) {
                                ...
                                try {
                                    ...
                                    if (k.message == i18n.phonenumbers.Error.INVALID_COUNTRY_CODE && i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(h)) {
                                        if (h = h.replace(i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN, ""), 
                                        g = this.maybeExtractCountryCode(h, f, a, c, d), 0 == g) throw k;
                                    } else throw k;
                                }
                                0 != g ? (e = this.getRegionCodeForCountryCode(g), e != b && (f = this.getMetadataForRegionOrCallingCode_(g, e))) : (i18n.phonenumbers.PhoneNumberUtil.normalizeSB_(e), 
                                a.append(e.toString()), null != b ? (g = f.getCountryCodeOrDefault(), d.setCountryCode(g)) : c && d.clearCountryCodeSource());
                                ...
                                this.maybeStripNationalPrefixAndCarrierCode(e, f, b), f = this.testNumberLength_(e.toString(), f), 
                                g = i18n.phonenumbers.PhoneNumberUtil.ValidationResult, f != g.TOO_SHORT && f != g.IS_POSSIBLE_LOCAL_ONLY && f != g.INVALID_LENGTH && (a = e, 
                                c && 0 < b.toString().length && d.setPreferredDomesticCarrierCode(b.toString())));
                                c = a.toString();
                                a = c.length;
                            ...
                            i18n.phonenumbers.shortnumbermetadata.countryToMetadata = {
                                ...
                                AT: [ , [ , , "[168]\\d\\d(?:\\d(?:\\d{2})?)?", , , , , , , [ 3, 4, 6 ] ], , , [ , , "1(?:12|2[0238]|3[03]|4[0-247])|1(?:16\\d\\d|4[58])\\d", , , , "112" ], [ , , , , , , , , , [ -1 ] ], , , , "AT", , , , , , , , , , , , , , , , , , [ , , "1(?:[12]2|33|44)", , , , "112", , , [ 3 ] ], , [ , , "1(?:1(?:2|6(?:00[06]|1(?:17|23)))|2[0238]|3[03]|4(?:[0-247]|5[05]|84))|(?:61|8108[1-3])0", , , , "112" ], [ , , , , , , , , , [ -1 ] ], [ , , "610|810\\d{3}", , , , "610", , , [ 3, 6 ] ], , [ , , , , , , , , , [ -1 ] ] ],
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.maybeCreateNewTemplate_ = function() {
                                for (var a = this.possibleFormats_.length, b = 0; b < a; ++b) {
                                    ...
                                    if (this.createFormattingTemplate_(c)) return this.currentFormattingPattern_ = d, 
                                    this.shouldAddSpaceAfterNationalPrefix_ = i18n.phonenumbers.AsYouTypeFormatter.NATIONAL_PREFIX_SEPARATORS_PATTERN_.test(c.getNationalPrefixFormattingRule()), 
                                    this.lastMatchPosition_ = 0, !0;
                                }
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.inputDigitWithOptionToRememberPosition_ = function(a, b) {
                                ...
                                this.isDigitOrLeadingPlusSign_(a) ? a = this.normalizeAndAccrueDigitsAndPlusSign_(a, b) : (this.ableToFormat_ = !1, 
                                ...
                                if (!this.ableToFormat_) {
                                    ...
                                    } else if (this.ableToExtractLongerNdd_()) return this.prefixBeforeNationalNumber_.append(i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_), 
                                ...
                                switch (this.accruedInputWithoutFormatting_.getLength()) {
                                  ...
                                  case 3:
                                    if (this.attemptToExtractIdd_()) this.isExpectingCountryCallingCode_ = !0; else return this.extractedNationalPrefix_ = this.removeNationalPrefixFromNationalNumber_(), 
                                    this.attemptToChooseFormattingPattern_();

                                  default:
                                    if (this.isExpectingCountryCallingCode_) return this.attemptToExtractCountryCallingCode_() && (this.isExpectingCountryCallingCode_ = !1), 
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToFormatAccruedDigits_ = function() {
                                for (var a = this.nationalNumber_.toString(), b = this.possibleFormats_.length, c = 0; c < b; ++c) {
                                    ...
                                    if (new RegExp("^(?:" + e + ")$").test(a) && (this.shouldAddSpaceAfterNationalPrefix_ = i18n.phonenumbers.AsYouTypeFormatter.NATIONAL_PREFIX_SEPARATORS_PATTERN_.test(d.getNationalPrefixFormattingRule()), 
                                    d = a.replace(new RegExp(e, "g"), d.getFormat()), d = this.appendNationalNumber_(d), 
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.getRememberedPosition = function() {
                                ...
                                for (var a = 0, b = 0, c = this.accruedInputWithoutFormatting_.toString(), d = this.currentOutput_.toString(); a < this.positionToRemember_ && b < d.length; ) c.charAt(a) == d.charAt(b) && a++, 
                                b++;
                                return b;
                            };
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToChooseFormattingPattern_ = function() {
                                var a = this.nationalNumber_.toString();
                                return a.length >= i18n.phonenumbers.AsYouTypeFormatter.MIN_LEADING_DIGITS_LENGTH_ ? (this.getAvailableFormats_(a), 
                                a = this.attemptToFormatAccruedDigits_(), 0 < a.length ? a : this.maybeCreateNewTemplate_() ? this.inputAccruedNationalNumber_() : this.accruedInput_.toString()) : this.appendNationalNumber_(a);
                            };
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.removeNationalPrefixFromNationalNumber_ = function() {
                                ...
                                if (this.isNanpaNumberWithNationalPrefix_()) b = 1, this.prefixBeforeNationalNumber_.append("1").append(i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_), 
                                this.isCompleteNumber_ = !0; else if (this.currentMetadata_.hasNationalPrefixForParsing()) {
                                    var c = new RegExp("^(?:" + this.currentMetadata_.getNationalPrefixForParsing() + ")");
                                    c = a.match(c);
                                    null != c && null != c[0] && 0 < c[0].length && (this.isCompleteNumber_ = !0, b = c[0].length, 
                                    this.prefixBeforeNationalNumber_.append(a.substring(0, b)));
                                }
                                this.nationalNumber_.clear();
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToExtractIdd_ = function() {
                                ...
                                b = a.match(b);
                                return null != b && null != b[0] && 0 < b[0].length ? (this.isCompleteNumber_ = !0, 
                                b = b[0].length, this.nationalNumber_.clear(), this.nationalNumber_.append(a.substring(b)), 
                                this.prefixBeforeNationalNumber_.clear(), this.prefixBeforeNationalNumber_.append(a.substring(0, b)), 
                                a.charAt(0) != i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN && this.prefixBeforeNationalNumber_.append(i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_), 
                                !0) : !1;
                            };
                            ...
                            i18n.phonenumbers.AsYouTypeFormatter.prototype.normalizeAndAccrueDigitsAndPlusSign_ = function(a, b) {
                                ...
                                } else c = i18n.phonenumbers.PhoneNumberUtil.DIGIT_MAPPINGS[a], this.accruedInputWithoutFormatting_.append(c), 
                                this.nationalNumber_.append(c);
    ...
    (() => {
        ...
        function subMenuInit() {
            ...
            subMenus.forEach((subMenuElement => {
                const subMenuTitleSpans = subMenuElement.querySelectorAll("[data-subMenu-title] > *");
                if (!subMenuTitleSpans) return;
                subMenuTitleSpans.forEach((subMenuTitleSpan => {
                    subMenuTitleSpan.addEventListener("click", (function(e) {
                        if (isAnimating) return;
                        e.preventDefault();
                        const subMenuTitle = subMenuElement.querySelector("[data-subMenu-title]");
                        const subMenuList = subMenuTitle.nextElementSibling;
                        const isActive = subMenuTitle.parentElement.classList.contains("sub-menu-active");
                        document.querySelectorAll(".sub-menu-active").forEach((menu => {
                            if (menu !== subMenuTitle.parentElement) {
                                menu.classList.remove("sub-menu-active");
                                _slideUp(menu.querySelector("[data-subMenu-list]"), duration);
                            }
                        }));
                        if (isActive) {
                            subMenuTitle.parentElement.classList.remove("sub-menu-active");
                            _slideUp(subMenuList, duration);
                        } else {
                            subMenuTitle.parentElement.classList.add("sub-menu-active");
                            _slideDown(subMenuList, duration);
                        }
                        isAnimating = true;
                        setTimeout((() => {
                            isAnimating = false;
                ...
                const subMenuList = subMenuElement.querySelector("[data-subMenu-title]").nextElementSibling;
                if (!subMenuList.getAttribute("hidden")) _slideUp(subMenuList, 0);
            }));
        }
        subMenuInit();
        window.onload = () => {
            ...
            function addPlusIfEmpty() {
                if (phoneInput.value === "") phoneInput.value = "+";
            }
            if (phoneInput) phoneInput.addEventListener("input", (() => {
                if (!phoneInput.value.startsWith("+")) phoneInput.value = "+" + defaultCountryCode + phoneInput.value;
                highlightCountry();
                addPlusIfEmpty();
            }));
            function highlightCountry() {
                ...
                if (phoneNumber.length >= 3) {
                    ...
                    try {
                        ...
                        if (countryRegionCode) countryNameSpan.textContent = countryRegionCode; else console.error("Невідомий код країни");
                    } catch (error) {
                        console.error("Помилка при обробці номера телефону: " + error.message);
                    }
                }
            }
        };
        (function activeCurrentMenu() {
            ...
            menuLink.forEach((item => {
                ...
                if (currentLink.includes(linkHref)) item.classList.add("menu-active");
            }));
        })();
        window["FLS"] = false;
        isWebp();
